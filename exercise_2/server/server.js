...
app.get('/api', (req, res) => {
  res.json({
    ...
    endpoints: [
      ...
      {method: 'GET', path: '/api/exercise2', description: 'Sends a message to the user that this application has been deployed using docker.'}
...
app.get('/api/exercise2', (req, res) => {
  res.send('group 118 application deployed using docker');
})
